    ...
    const fxPairs = [...pairGroups.entries()]
        .map(([key, list]) => {
            ...
            return {
                ...
                volumeSpent: roundNative(from === base ? baseVolume : quoteVolume, from),
                volumeReceived: roundNative(to === base ? baseVolume : quoteVolume, to),
    ...
    const conversions = crossTransfers
        .map(t => {
            ...
            return {
                ...
                spent: roundNative(t.fromAmount!, t.fromCurrency!),
                spentCurrency: t.fromCurrency!,
                received: roundNative(t.toAmount!, t.toCurrency!),
